...
mylabels=c("lmFront", "lIns", "ACC", "rmFront", "rIns", "lLobVI", "rLobVI", # anterior Salience
           "lmFront", "lSupMa", "lPrec", "rmCing", "rsPar", "rSupMa", "lThal", "LobVI",
           "lpIns", "rThal", "LobIV", "rpIns") # post Salience
```
...
$FSLEYES --standard1mm $OPTS \
   $ATLAS_SHIRER/anterior_Salience/01/1.nii -cm red -a 50 \
   $ATLAS_SHIRER/anterior_Salience/02/2.nii -cm yellow -a 50 \
   $ATLAS_SHIRER/anterior_Salience/03/3.nii -cm green -a 50 \
   $ATLAS_SHIRER/anterior_Salience/04/4.nii -cm blue -a 50 \
   $ATLAS_SHIRER/anterior_Salience/05/5.nii -cm copper -a 50 \
   $ATLAS_SHIRER/anterior_Salience/06/6.nii -cm red -a 50 \
   $ATLAS_SHIRER/anterior_Salience/07/7.nii -cm green -a 50 \
   $ATLAS_SHIRER/post_Salience/01/1.nii -cm blue -a 50 \
   $ATLAS_SHIRER/post_Salience/02/2.nii -cm copper -a 50 \
   $ATLAS_SHIRER/post_Salience/03/3.nii -cm red -a 50 \
   $ATLAS_SHIRER/post_Salience/04/4.nii -cm yellow -a 50 \
   $ATLAS_SHIRER/post_Salience/05/5.nii -cm green -a 50 \
   $ATLAS_SHIRER/post_Salience/06/6.nii -cm blue -a 50 \
   $ATLAS_SHIRER/post_Salience/07/7.nii -cm copper -a 50 \
   $ATLAS_SHIRER/post_Salience/08/8.nii -cm red -a 50 \
   $ATLAS_SHIRER/post_Salience/09/9.nii -cm green -a 50 \
   $ATLAS_SHIRER/post_Salience/10/10.nii -cm blue -a 50 \
   $ATLAS_SHIRER/post_Salience/11/11.nii -cm copper -a 50 \
   $ATLAS_SHIRER/post_Salience/12/12.nii -cm red -a 50 \
```
...
p1 = gplotMat(stats.ctrl$adj, title = "controls", barWidth = 0.3,
  ...
  scale_x_continuous(breaks = 0.5:18.5, labels = mylabels)
